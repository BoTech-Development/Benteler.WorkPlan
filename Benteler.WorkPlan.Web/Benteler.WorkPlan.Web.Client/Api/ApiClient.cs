...
using Benteler.WorkPlan.Web.Client.Api.Clients;
using Benteler.WorkPlan.Web.Client.Api.Clients.Auth;
...
namespace Benteler.WorkPlan.Web.Client.Api
{
    public class ApiClient
    {
        ...
        {
            if (_instance == null) Error = await ApiClient.CreateApiClientFor("https://localhost:7067"); // https://localhost:7236
			return _instance;
        }
        /// <summary>
